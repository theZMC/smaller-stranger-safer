...
security**, given at [Arkansec](https://arkansec.org) on 2026-09-03. Slides:
...
The demo app is **orders-api**, a deliberately boring Express service. The
point of the talk is that the size and the CVEs come from the base image and
the packaging, not from your code.
